...
<%--  SLIDER  --%>
<asp:Content ContentPlaceHolderId="PlaceHolderSliderHome" runat="server">
</asp:Content>

<%--  ICONOS PRINCIPALES  --%>
<asp:Content ContentPlaceHolderId="PlaceHolderIconosPP" runat="server">
</asp:Content>

<%--  TURISMO  --%>
<asp:Content ContentPlaceHolderId="PlaceHolderTurismo" runat="server">
</asp:Content>

<%--  NOTICIAS  --%>
<asp:Content ContentPlaceHolderId="PlaceHolderNoticias" runat="server">
</asp:Content>
